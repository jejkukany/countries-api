...
export default async function countryModal({
	...
	return (
		<Modal>
			...
			<div className="items-center align-middle justify-center flex gap-4">
				<img
					src={country.flags.png}
					alt={country.name.official}
					className="rounded-md shadow-lg border-4 border-neutral-200 w-[310px]"
				/>
				<div className="flex flex-col items-center w-full text-black p-5 text-center">
					...
					<p className="font-bold text-lg">
						Borders: <span className="font-normal">{borders}</span>
					</p>
				</div>
			</div>
		</Modal>
